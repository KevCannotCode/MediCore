...
const ModifyAppointment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:8080/Appointments/doctorUpdate/"+ formData._id +"/" + formData.medicalRecord, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  > 
    <div>
      <h2>Update Existing Appointment</h2>
      <text>Feel free to add details for your patient!</text>
    </div>
    ...
    >
      ...
      <input style={{backgroundColor: "grey"}}
        ...
        readOnly /* Prevent editing the doctor's email */
    ...
    >
      ...
      <input style={{backgroundColor: "grey"}}
        ...
        value={formData.time}
        onChange={handleChange}
        readOnly /* Prevent editing the date */
    ...
    >
      ...
      <textarea style={{backgroundColor: "grey"}}
        ...
        onChange={handleChange}
        readOnly /* Prevent editing the reason for the appointment */
    ...
    <div className="form-group">
      <label htmlFor="medicalRecord">Update Medical Record:</label>
      <select
        id="medicalRecord"
        name="medicalRecord"
